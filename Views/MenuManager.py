...
# Form implementation generated from reading ui file 'MenuManager.ui'
#
...
class Ui_MenuManager(object):
    def setupUi(self, MenuUser):
        ...
        self.manager = QtWidgets.QLabel(self.CentaralWidget)
        font = QtGui.QFont()
        font.setPointSize(26)
        font.setBold(True)
        font.setWeight(75)
        self.manager.setFont(font)
        self.manager.setAlignment(QtCore.Qt.AlignCenter)
        self.manager.setObjectName("manager")
        self.horizontalLayout_2.addWidget(self.manager)
    ...
    def retranslateUi(self, MenuUser):
        ...
        self.manager.setText(_translate("MenuUser", "Менеджер"))
        ...
        item.setText(_translate("MenuUser", "номер1"))
        item = self.Table.item(0, 3)
        item.setText(_translate("MenuUser", "средства1"))
        item = self.Table.item(0, 4)
        item.setText(_translate("MenuUser", "сосотояние1"))
        item = self.Table.item(1, 0)
        item.setText(_translate("MenuUser", "банк2"))
        item = self.Table.item(1, 2)
        item.setText(_translate("MenuUser", "номер2"))
        item = self.Table.item(1, 3)
        item.setText(_translate("MenuUser", "средства2"))
        item = self.Table.item(1, 4)
        item.setText(_translate("MenuUser", "состоняние2"))
        item = self.Table.item(2, 0)
        item.setText(_translate("MenuUser", "банк3"))
        item = self.Table.item(2, 2)
        item.setText(_translate("MenuUser", "номер3"))
        item = self.Table.item(2, 3)
        item.setText(_translate("MenuUser", "средства3"))
        item = self.Table.item(2, 4)
        item.setText(_translate("MenuUser", "состояние3"))
